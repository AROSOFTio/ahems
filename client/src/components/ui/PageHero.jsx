...
export function PageHero({ eyebrow, title, description, primaryAction, secondaryAction, stats }) {
  return (
    <SurfaceCard className="hero-card col-span-12 overflow-hidden p-6 sm:p-8 lg:p-10">
      <div className={`grid gap-8 ${stats?.length ? "lg:grid-cols-[1.5fr,0.9fr]" : ""}`}>
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            ...
            {description ? <p className="max-w-2xl text-base leading-7 text-brand-muted sm:text-lg">{description}</p> : null}
          </div>
